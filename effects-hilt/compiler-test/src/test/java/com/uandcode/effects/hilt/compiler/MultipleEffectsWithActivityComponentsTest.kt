...
class MultipleEffectsWithActivityComponentsTest : AbstractHiltKspTest() {
    ...
    private val expectedEffectInterfaceModule = """
        ...
        internal object EffectModule {
            ...
            fun registerEffect(): InternalRegisteredEffect {
                return InternalRegisteredEffect(Effect::class, AbstractInternalQualifier.activity)
            }
    ...
    @Test
    fun `compilation of 2 effects installed to ActivityComponent should complete`() = with(compile(source)) {
        assertCompiled()
