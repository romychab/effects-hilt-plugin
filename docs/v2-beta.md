...
:warning: This page covers the 2.x release, which is currently in beta. 
...
3. Ensure the [KSP] plugin is added to your project. [How to install KSP?](/docs/ksp-installation.md).
