    ...
    public data class Default(
        ...
        override fun effectNotFoundMessage(clazz: KClass<*>): String {
            return "Effect '${clazz.simpleName}' not found.\n" +
                    ...
                    "2. Review your DI framework configuration and make sure you have configured both DI and KSP plugin properly.\n" +
                    "3. If you write an integration test, make sure you have replaced RootEffectComponents properly."
        }
