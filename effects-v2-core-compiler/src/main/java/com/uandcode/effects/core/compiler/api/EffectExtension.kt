 ...
 *
 * // 2. Add the dependency from this core compiler module
 *
...
public interface EffectExtension {
    ...
    /**
     * Define an annotation that marks the application class.
     * For example, Hilt uses `@HiltAndroidApp`. Core compiler uses `@EffectApplication`.
     * Your own extension may use any other annotation.
     */
    public val applicationAnnotation: ClassName
     ...
     *
     * The annotation class must contain at least 3 parameters:
