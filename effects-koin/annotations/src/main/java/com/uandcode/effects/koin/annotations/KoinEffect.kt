 ...
 * lifecycle than your implementation's lifecycle. By default, proxy implementations
 * are placed into global Koin context, but you can optionally scope them by
 * using [InstallEffectToClassScope] or [InstallEffectToNamedScope] annotations.
 *
 ...
 * }
 *
 * // 2. Implement the interface and annotate it with @KoinEffect
 * @KoinEffect
 * class MyEffectsImpl(
...
public annotation class KoinEffect(
