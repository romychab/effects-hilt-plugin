...
3. Add the following dependencies:
   ...
   ksp("com.uandcode:effects2-koin-compiler:2.2.0")
   // for projects without Jetpack Compose:
...
2. Add the following dependencies:
   ...
   ```kotlin
   // annotation processor:
   ksp("com.uandcode:effects2-core-compiler:2.2.0")
   // for projects without Jetpack Compose:
...
- Dependencies for your __application module__ remain the same:
  ...
  // Koin Integration:
  ksp("com.uandcode:effects2-koin-compiler:2.2.0")
  implementation("com.uandcode:effects2-koin:2.2.0") // without Jetpack Compose
  implementation("com.uandcode:effects2-koin-compose:2.2.0") // with Jetpack Compose
  
  // No DI:
  ksp("com.uandcode:effects2-core-compiler:2.2.0")
  implementation("com.uandcode:effects2-core-lifecycle:2.2.0") // without Jetpack Compose
  implementation("com.uandcode:effects2-core-compose:2.2.0") // with Jetpack Compose
  ```
